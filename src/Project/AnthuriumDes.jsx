      ...
      <div style={divStyle}>
        <Paper elevation={7} style={containerStyle}>
          ...
          <Typography style={sectionStyle}>
            Indoors or out, anthuriums like sun more than shade. They grow best
            in bright, indirect light. Avoid direct sun.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
            Soil🌱
          </Typography>
          ...
          <Typography style={sectionStyle}>
            ...
            completely. Set the pot in a tray with rocks or gravel that has
            water. The plant's water can drain there and help keep humidity
            levels higher around the plant. Allow the top of the soil to dry out
            to the touch before watering again. Indoors, this is about once a
            week. If outside, during hot days, it can be every two or three days
            between waterings.
          </Typography>
          <Typography variant="h5" gutterBottom style={headingStyle}>
          ...
          <Typography style={sectionStyle}>
            All species of anthurium are native tropical plants, and mimicking
            those conditions will give you the best chances for success. This
            plant prefers high humidity and temperatures between 65 and 85
            degrees Fahrenheit. These plants can be grown outside in zones 11 to
            12 and will likely perish at temperatures of 40 degrees Fahrenheit
            or less. In dry climates—or during dry winter months—mist the plant
            daily to keep humidity levels high. You may find it necessary to run
            a humidifier constantly during dry months.
          </Typography>
          <br></br>
          <br></br>
          <Link to="/pathap">
